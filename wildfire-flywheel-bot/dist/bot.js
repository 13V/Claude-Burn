...
bot.start((ctx) => {
    ctx.replyWithHTML("<b>🔒 THE VAULT IS OPEN</b>\n\n" +
...
bot.command('stats', async (ctx) => {
    try {
        ...
        ctx.replyWithHTML("<b>📊 THE VAULT DASHBOARD</b>\n\n" +
...
bot.command('fire', (ctx) => {
    ctx.replyWithHTML("<b>🔒 THE VAULT ACKNOWLEDGES YOU</b>\n\n" +
...
export async function notifyBuyback(solAmount, tokenAmount, signature, burnSignature) {
    const message = "<b>🔒 THE VAULT IS OPEN</b>\n\n" +
